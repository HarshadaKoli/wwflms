...
<div class="box-body">
 ...
 <form class="form-horizontal" action="{{ URL::to('/registerstatus')}}" method="POST" autocomplete="off" enctype="multipart/form-data">
 {{ csrf_field() }}
...
<div class="form-group col-lg-3" style="margin-left: 11px;">
<label>Status Name</label><r style="color: red">*</r>
 <input type="text" class="form-control" name="status_name" placeholder="Status Name">
<br></div>
