...
<div class="box-body">
 ...
 <form class="form-horizontal" action="{{ URL::to('/registerindustry')}}" method="POST" autocomplete="off" enctype="multipart/form-data">
 {{ csrf_field() }}
...
<label>Industry Name</label><r style="color: red">*</r>
 <input type="text" class="form-control" name="industry_name" placeholder="Industry Name">
<br></div>
