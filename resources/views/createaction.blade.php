...
<div class="box-body">
 ...
 <form class="form-horizontal" action="{{ URL::to('/registeraction')}}" method="POST" autocomplete="off" enctype="multipart/form-data">
 {{ csrf_field() }}
...
<div class="form-group col-lg-3" style="margin-left: 11px;">
<label>Action Name</label><r style="color: red">*</r>
