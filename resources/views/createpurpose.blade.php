...
<div class="box-body">
 ...
 <form class="form-horizontal" action="{{ URL::to('/registerpurpose')}}" method="POST" autocomplete="off" enctype="multipart/form-data">
 {{ csrf_field() }}
...
<div class="form-group col-lg-3" style="margin-left: 11px;">
<label>Purpose Name</label><r style="color: red">*</r>
 <input type="text" class="form-control" name="purpose_name" placeholder="Purpose Name">
<br></div>
